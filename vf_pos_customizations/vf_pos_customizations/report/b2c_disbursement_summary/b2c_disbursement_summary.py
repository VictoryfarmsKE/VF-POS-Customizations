...
def get_columns():
    return [
        ...
        },
        {
            ...
            "fieldtype": "Link",
            "label": "Disbursement",
            "options": "VF B2C Payment Disbursement",
            "width": 250,
        },
        {
...
def get_data(filters):
    ...
    Disbursement = frappe.qb.DocType("VF B2C Payment Disbursement")
    Reference = frappe.qb.DocType("VF B2C Payment Disbursement Reference")
